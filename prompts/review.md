...
只输出一个 JSON 数组（不要其他文字），对标题和口播稿各评一项。verdict 规则：total ≥ 80 为 "pass"，60-79 为 "revise"，<60 为 "reject"。

[
  {
    "target": "title",
    "scores": { "hook": 8, "clarity": 9, "platform_fit": 8, "compliance": 10 },
    "total": 86,
    "verdict": "pass",
    "issues": ["发现的具体问题"],
  ...
  {
    "target": "script",
    "scores": { "hook": 7, "clarity": 8, "platform_fit": 8, "compliance": 10 },
    "total": 82,
    "verdict": "pass",
    "issues": [],
    "suggestions": []
